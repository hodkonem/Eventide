...
import ru.itwizardry.micro.product.service.event.ProductCreatedEvent;
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.producer.properties.enable.idempotency}")
    private String idempotency;

    @Value("${spring.kafka.producer.properties.max.in.flight.requests.per.connnection}")
